...
public class CategoryActivity extends Activity {
	...
	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,
				long id) {
			Map<String, Object> map = mData.get(position - 1);
			String cate = (String) map.get("title");
			String encodeCate;
			try {
				encodeCate = URLEncoder.encode(cate, "utf-8");
				String nearbyArea = URLEncoder.encode("南湖公园/三好街", "utf-8");
				String url = getResources().getText(R.string.host)
						+ "PlaceServlet?placeOperation=doubleValues&searchName1=area_name&searchValue1="
						+ nearbyArea
						+ "&searchName2=category_name&searchValue2="
						+ encodeCate;
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			isBack = true;
			// Animation mAnimationScale =new ScaleAnimation(1.0f, 0.0f, 1.0f,
			// 0.0f,
			// Animation.RELATIVE_TO_SELF, 0.5f,
			// Animation.RELATIVE_TO_SELF, 0.5f);
			//
